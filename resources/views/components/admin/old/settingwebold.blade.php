        ...
        <form action="{{ url('/setting/web') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-lg-10">
                        <img width="100" src="{{ asset($web->og_image) }}" alt="kbrstore">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-lg-10">
                        <img width="100" src="{{ asset($web->logo_favicon) }}" alt="kbrstore">
        ...
        <form action="{{ url('/setting/tentang-kami') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-lg-10">
                        <img width="100" src="{{ asset($web->logo_ceo) }}" alt="kbrstore">
...
<div class="card">
    <div class="card-body">
        ...
        <a style="color:#ff6262;" href="https://wa.me/62895346404969">Klik Disini Untuk Hubungi Developer</a>
