...
.akumauweb-shadow {
    ...
    <body style="color: rgb(230, 230, 230);">
       <div class="w-full h-[100vh] absolute -z-10 lg:block md:block hidden  ">
                    <img alt="bg-login" layout="responsive" sizes="100vw" srcSet="/cdn/image/bg-auth.webp" src="/cdn/image/bg-auth.webp" decoding="async" data-nimg="fill" class="object-cover" style="position:absolute;height:100%;width:100%;left:0;top:0;right:0;bottom:0;color:transparent"/>
                </div>
                ...
                <div class="w-full md:w-1/2 lg:w-[35%] mt-[30px]">
                     @if(session('success'))
                        <script>
                            $(document).ready(function() {
                                ...
                                toastr.warning("Register Berhasil!!!", "Success register!!!", {
                        ...
                        <script>
                            $(document).ready(function() {
                                ...
                                toastr.warning("Username atau password salah, silahkan dicoba kembali.", "Failed login", {
                                    "positionClass": "toast-top-right",
                                    "progressBar": true,
                                    "showDuration": "300",
                                    "hideDuration": "1000",
                    ...
                    <form role="form" action="{{ url('/login') }}" method="POST">
                        ...
                        <div class="relative mb-[20px] undefined">
                            ...
                            />
                            <label class="absolute text-md duration-300 transform -translate-y-3 scale-75 top-4 z-10 origin-[0] left-5 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3 undefined css-qe1ax5">
                                Kata Sandi
                            </label>
                            <div>
                        ...
                        <div class="mb-8 text-[14px] justify-between flex">
                            ...
                            <!--    <input required="" type="checkbox" name="tac" id="tac" class="w-4 h-4 !rounded-lg "/>-->
                            <!--    <label for="tac" class="ml-2 text-sm font-medium">Ingatkan saya</label>-->
                            <!--</div>-->
                            <a style="color:#cbcbcb" href="{{url('/forgot-password')}}">Lupa Kata Sandi?</a>
                        </div>
                                
                        
                        <button
                           type="submit" name="tombol" value="submit"
                            class="btn btn-primary px-4 py-3 w-100 inline-flex w-full justify-center rounded-full text-sm font-semibold px-4 hover:scale-105 duration-300 items-center"
                            style="color: rgb(255, 255, 255); background: var(--warna_5);"
                        >
                            <span>Masuk</span>
                        </button>
                    </form>
                    ...
                    <div class="flex items-center my-7">
                        ...
                        <span class="flex-shrink text-sm px-4 font-light" style="color: rgb(203, 203, 203);">Belum punya akun?</span>
                        <div class="flex-grow h-px" style="background: rgb(203, 203, 203);"></div>
                    </div>
                    <a class="inline-flex w-full py-3 px-4 justify-center text-sm font-semibold border rounded-full hover:scale-105 duration-300" href="{{ url('/register') }}" style="color: rgb(39, 39, 39); background: rgb(255, 255, 255);">
                        Daftar Sekarang
                    </a>
                </div>
            </div>
