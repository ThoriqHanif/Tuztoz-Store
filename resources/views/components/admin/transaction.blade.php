                                    ...
                                    <td>
                                        <div class="btn-group-vertical">
                                            <button id="btnGroupDrop1" type="button"
                                                ...
                                                {{ $data_pesanan->status }} <i class="mdi mdi-chevron-down"></i> </button>
                                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <li><a class="dropdown-item"
                                                        href="/order-status/{{ $data_pesanan->order_id }}/Success">Success</a>
                                                </li>
                                                <li><a class="dropdown-item"
                                                        href="/order-status/{{ $data_pesanan->order_id }}/Batal">Batal</a>
                                                </li>
                                                <li><a class="dropdown-item"
                                                        href="/order-status/{{ $data_pesanan->order_id }}/Pending">Pending</a>
                                                </li>
                                        </div>
                                    </td>
