                                                    ...
                                                    <div _ngcontent-vyn-c93=""
                                                        ...
                                                        <span _ngcontent-vyn-c93="">
                                                            <div class="flex items-center gap-1">
                                                                ...
                                                                <span
                                                                    class="text-xl font-bold uppercase leading-[26px] tracking-[0.2em] text-primary-400" style="style="color: var(--warna_5);"">Flashsale</span>
                                                                ...
                                                                <div class="slide-container swiper">
                                                                    <div class="slide-content swiper-initialized swiper-horizontal swiper-backface-hidden">
                                                                        <div class="card-wrapper swiper-wrapper"
                                                                            ...
                                                                            <div class="swiper-slide" style="width: 127.636px; margin-right: 16px;">
...
<div class="col-lg-11 mx-auto mt-4">
    <h3 class="mb-3 text-lgh font-semibold uppercase leading-relaxed tracking-wider" style="color: var(--warna_5);">BEST SELLER <i class="fa-solid fa-star"></i></h3>
    <style>
        .blur-sm {
            position: relative;
            overflow: hidden;
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
        @php $count = 0 @endphp
        @foreach($kategori as $jsgori)
            @if($jsgori->tipe == "populer" && $count < 6)
                <a tabindex="0" href="{{ url('/order/' . $jsgori->kode) }}" class="blur-sm blur-sm-{{ $jsgori->id }} relative flex items-center gap-2 rounded-xl p-2">
                    <img src="{{ url('') . $jsgori->thumbnail }}" loading="lazy" class="z-10 h-14 w-14 rounded-xl object-cover">
...
<!--                        <button class="btn btn-category nav-link btn-color text-lg flex border-b-2 py-2 px-3 outline-none border-primary-500" id="gamelainnya-tab" data-bs-toggle="tab" data-bs-target="#gamelainnya" type="button" role="tab" aria-controls="gamelainnya">-->
<!--                            <small class="text-dark">Game Lainnya</small>-->
<!--                        </button>-->
<!--                    </li>-->
<!--                    <li class="nav-item" role="presentation">-->
<!--                        <button class="btn btn-category nav-link btn-color text-lg flex border-b-2 py-2 px-3 outline-none border-primary-500" id="pulsa-tab" data-bs-toggle="tab" data-bs-target="#pulsa" type="button" role="tab" aria-controls="pulsa">-->
<!--                            <small class="text-dark">Pulsa</small>-->
<!--                        </button>-->
<!--                    </li>-->
<!--                </ul>-->
<!--            </div>-->
        ...
        <ul class="nav nav-pills nav-fill horitab-scroll" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="btn btn-outline-secondary rounded-pill px-4 py-2 text-sm shadow-lg duration-300"
                        id="populer-tab" data-bs-toggle="pill" data-bs-target="#populer" type="button" role="tab"
                        aria-controls="populer" aria-selected="true" style="background-color: #4a4a4a;"><small style="color: var(--warna_5);">Game</small></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="btn btn-outline-secondary rounded-pill px-4 py-2 text-sm shadow-lg duration-300"
                        id="Pulsa-tab" data-bs-toggle="pill" data-bs-target="#Pulsa" type="button" role="tab"
                        aria-controls="Pulsa" style="background-color: #4a4a4a;"><small style="color: var(--warna_5);">Pulsa</small></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="btn btn-outline-secondary rounded-pill px-4 py-2 text-sm shadow-lg duration-300"
                        id="Token-tab" data-bs-toggle="pill" data-bs-target="#Token" type="button" role="tab"
                        aria-controls="Token" style="background-color: #4a4a4a;"><small style="color: var(--warna_5);">Token</small></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="btn btn-outline-secondary rounded-pill px-4 py-2 text-sm shadow-lg duration-300"
                        id="liveapp-tab" data-bs-toggle="pill" data-bs-target="#liveapp" type="button" role="tab"
                        aria-controls="liveapp" style="background-color: #4a4a4a;"><small style="color: var(--warna_5);">Voucher</small></button>
            </li>
        </ul>
    </div>
</div>
            ...
            <div class="col-lg-11 mx-auto mt-4">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane" id="akun_premium" role="tabpanel" aria-labelledby="akun_premium-tab">
                        <div
                            ...
                            @foreach($kategori as $jsgori)@if($jsgori->tipe == "akun_premium") <a href="{{ env('APP_URL').'/order/'.$jsgori->kode }}"
                                class="featured-game-card relative hover:shadow-sm hover:cursor-pointer  group relative overflow-hidden rounded-2xl  hover:ring-primary-500 duration-300  hover:shadow-2xl hover:ring-2   hover:ring-offset-white-500">
                                <div class="blur-sharp ">
                                    <div
                                        class="relative h-[9.4rem] sm:h-[14.4rem] md:h-[14.4rem] lg:h-[10.4rem] xl:w-auto ">
                    ...
                    <div class="tab-pane" id="gamelainnya" role="tabpanel" aria-labelledby="gamelainnya-tab">
                        <div
                            class="mt-2 md:mt-10 grid grid-cols-3 gap-3 sm:grid-cols-4 sm:gap-3 md:grid-cols-5 md:gap-3 lg:grid-cols-6 lg:gap-3 xl:grid-cols-6 xl:gap-5">
...
<div class="tab-pane" id="Token" role="tabpanel" aria-labelledby="Token-tab">
    <div
        class="mt-2 md:mt-10 grid grid-cols-3 gap-3 sm:grid-cols-4 sm:gap-3 md:grid-cols-5 md:gap-3 lg:grid-cols-6 lg:gap-3 xl:grid-cols-6 xl:gap-5">
        @foreach($kategori as $jsgori)@if($jsgori->tipe == "Token") <a
            href="{{ env('APP_URL').'/order/'.$jsgori->kode }}"
            class="featured-game-card relative hover:shadow-sm hover:cursor-pointer  group relative overflow-hidden rounded-2xl  hover:ring-primary-500 duration-300  hover:shadow-2xl hover:ring-2   hover:ring-offset-white-500">
            <div class="blur-sharp ">
            ...
            <div class="cover !absolute bottom-0 m-3 h-full">
                <div class="flex flex-col h-full justify-between no-underline">
                    <div class="relative p-3 mx-auto my-auto h-15 w-10 lg:h-14 lg:w-14">
                        <img alt="icon-mbgs" sizes="100vw" srcset="{{ url('') }}{{ !$config ? '' : $config->og_image }}"
                            src="{{ url('') }}{{ !$config ? '' : $config->og_image }}" decoding="async" data-nimg="fill"
                            class="object-center object-cover" loading="lazy"
                            style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent; filter: brightness(0) invert(1);">
                    </div>
                    <div>
...
<!--                                            class="img-fluid">-->
<!--                                        <span class="text-white">{!! isset($popup->deskripsi) ? $popup->deskripsi : " <p-->
<!--                                                class='text-center'>-->
        ...
        <div class="col">
            <div class="flex items-center gap-3 rounded-xl p-3">
                ...
                <div class="text-xs md:text-sm">
                    ...
                    <div class="text-white text-opacity-70">TuzToz's collaboration with authorized publishers guarantees the success of each transaction, establishing trust among millions of Gamers in Indonesia.</div>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="flex items-center gap-3 rounded-xl p-3">
                ...
                <div class="text-xs md:text-sm">
                    ...
                    <div class="text-white text-opacity-70">If you face any issues, feel free to reach out to our online support. The TuzToz team will assess the problem and respond to you at the earliest opportunity.</div>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="flex items-center gap-3 rounded-xl p-3">
                ...
                <div class="text-xs md:text-sm">
                    ...
                    <div class="text-white text-opacity-70">TuzToz is dedicated to safeguarding all customer transaction, personal information, including payment and bank account data.</div>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="flex items-center gap-3 rounded-xl p-3">
                ...
                <div class="text-xs md:text-sm">
                    ...
                    <div class="text-white text-opacity-70">Once the payment is successfully completed, your purchases will be directly delivered to your account.</div>
                </div>
            </div>
        </div>
...
.product-card {
    ...
    width: 100%; /* Sesuaikan dengan kebutuhan desain responsif */
    max-width: 400px; /* Contoh lebar maksimum */
    margin: 0 auto; /* Untuk membuat product card berada di tengah */
    display: flex; /* Menjadikan product card sebagai flex container */
    transition: box-shadow 0.3s ease-in-out; /* Menambahkan transisi pada box-shadow saat dihover */
    background-color: #141414; /* Ganti nilai HEX sesuai dengan warna yang diinginkan */
    --tw-text-opacity: 1;
    color: #141414;
...
.adsasdadada-card::before {
    ...
    transition: left 5s linear infinite; /* Menambahkan transisi pada left untuk efek bergerak */
    z-index: 1 /* Membuat bayangan berada di bawah product card */
}

.product-card:hover::before {
    left: -100%; /* Menggeser ke kiri agar bayangan bergerak dari kanan ke kiri saat dihover */
}
...
.product-image {
    ...
    margin-right: 10px; /* Tambahkan margin-right untuk jarak antara gambar dan detail */
}
...
.product-details {
    ...
    display: flex;
    flex-direction: column;
    flex: 1; /* Mengisi sisa ruang dengan detail produk */
}
...
.flash-sale-countdown__item[_ngcontent-vyn-c93] .flash-sale-count[_ngcontent-vyn-c93] .count-text[_ngcontent-vyn-c93] span[_ngcontent-vyn-c93], .flash-sale-countdown__item[_ngcontent-vyn-c93] .flash-sale-count[_ngcontent-vyn-c93] .count-number[_ngcontent-vyn-c93] span[_ngcontent-vyn-c93] {
    text-align: center;
}
...
<style>
    .cardproduk {
        ...
        display: flex; /* Menjadikan product card sebagai flex container */
        transition: box-shadow 0.3s ease-in-out; /* Menambahkan transisi pada box-shadow saat dihover */
        background-color: #1f2937; /* Ganti nilai HEX sesuai dengan warna yang diinginkan */
        --tw-text-opacity: 1;
        color: #1f2937;
        background-repeat: repeat-x;
        background-position: top;
