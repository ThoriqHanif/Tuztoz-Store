<!--Navbar -->
    <header class="mb-5">
        <nav class="fixed top-0 z-40 w-full shadow-navbar" data-headlessui-state="open"
            style="background: var(--warna_2);">
                        ...
                        <div class="flex flex-shrink-0 items-center">
                            <a class="relative w-auto" href="{{ url('') }}">
                                <img alt="logo" srcset="{{ url('') }}{{ !$config ? '' : $config->logo_header }}"
                                    ...
                                    decoding="async" data-nimg="1" class="block h-11 w-auto"
                                    loading="lazy" style="color: transparent; width: 70px; height: 70px;" />
                            </a>
                        </div>
          ...
          <button id="headlessui-menu-button-:R1qd6:" type="button" aria-haspopup="menu" aria-expanded="false" data-headlessui-state="closed" aria-controls="headlessui-menu-items-:r0:"
            ...
            <div class="relative h-8 w-8">
              <img
                   ...
                   decoding="async"
                   data-nimg="fill"
                   class="rounded-full ring-1 ring-blcak"
                   loading="lazy"
...
<div class="flex w-full justify-center pt-4 pb-2.5 lg:pt-2.5 lg:pb-2.5 gap-3 items-center px-3.5"
    ...
    <p class="text-xs lg:text-sm font-normal">Akses Lebih Cepat Dengan Download <strong>Aplikasi TUZTOZ</strong> Di
        Playstore</p><a target="_blank" href="https://play.google.com/store/apps/details?id=com.xcashshop.app"><img
            ...
            src="/cdn/image/google-play.png" width="100" height="100" decoding="async" data-nimg="1" class="w-auto h-8"
