...
class BxystoreController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->key = "API3I2LHWE1677314047312";
    }
    ...
    public function order($uid = null, $zone = null, $service = null,$order_id = null)
    {
        ...
        $trxid = 'TS-' . rand();
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'https://a-api.bxystore.com/api/order');
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'https://a-api.bxystore.com/api/status');
        curl_setopt($ch, CURLOPT_POST, TRUE);
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'https://a-api.bxystore.com/api/service');
        curl_setopt($ch, CURLOPT_POST, TRUE);
