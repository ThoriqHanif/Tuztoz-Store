...
class updatePembelian extends Command
{
    ...
    public function handle()
    {
        ...
        if ($datas != null) {
            ...
            foreach ($datas as $data) {
                $pesan =
                    "*PEMBAYARAN BERHASIL*\n\n" .
                    "Yeay...\nKamu telah menyelesaikan pembayaran ;)\n\n" .
                    ...
                    "Mohon ditunggu ya, kami akan proses pembelian mu :)\n\n" .
                    "*Estimasi Proses :*\n" .
                    "• 1-5 Menit, max 24 Jam.\n\n" .
                    "© TOPUPKU.ID";
    ...
    public function msg($nomor, $msg)
    {
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => "https://wa.miliyan.id/send-message",
